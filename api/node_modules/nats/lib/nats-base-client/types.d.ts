...
export type { ServiceClient } from "./serviceclient";
import type { TypedSubscriptionOptions } from "./typedsub";
...
export interface NatsConnection {
     ...
     * @param opts
     */
    requestMany(subject: string, data: Uint8Array, opts: Partial<RequestManyOptions>): Promise<QueuedIterator<Msg>>;
    /**
